...
class Details extends React.Component{
    ...
    static getDerivedStateFromProps(nextProps, prevState){
        ...
        const newLevelType = root ? levelType : Details.levelFromType(level.type);
    ...
    _onGenerateReport(){
        ...
        data.append('type', serverEntities.BENEFICIARIES_INFORMATION);
        ...
        return (
            <div className={`form__wrapper`}>
                <header className="form__header">
                    <Text>Beneficiaries Details</Text>
                    <Button
