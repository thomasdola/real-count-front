...
import {Button, Intent, Radio, RadioGroup, Text} from '@blueprintjs/core';
...
class Allowance extends React.Component{
    ...
    static getDerivedStateFromProps(nextProps, prevState){
        ...
        const newLevelType = root ? levelType : Allowance.levelFromType(level.type);
    ...
    _onGenerateReport(){
        ...
        data.append('type', serverEntities.BENEFICIARIES_ALLOWANCE);
