...
class Enrollment extends React.Component{
    ...
    static getDerivedStateFromProps(nextProps, prevState){
        ...
        const newLevelType = root ? levelType : Enrollment.levelFromType(level.type);
    ...
    _onGenerateReport(){
        ...
        data.append('type', serverEntities.BENEFICIARIES_ENROLLMENT);
        ...
        return (
            <div className={`form__wrapper`}>
                <header className="form__header">
                    <Text>Beneficiaries Enrollment</Text>
                    <Button
